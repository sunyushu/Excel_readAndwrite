		...
		<div region="west" split="true" title="菜单" style="width:200px;">
			<div id="aa" class="easyui-accordion" fit="true">
				<div title="Excel导入导出" selected="true" style="overflow:auto;padding:5px;">
					<a title="<%=request.getContextPath() %>/jsp/templateList.jsp">数据导入</a><br/>
					<%--customer_list.action?page=1&rows=10--%>
					<a title="<%=request.getContextPath() %>/jsp/customerList.jsp">Om_cust_price_list信息</a><br/>
				</div>
			</div>
		</div>
